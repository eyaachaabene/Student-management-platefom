        ...
        <div class="signup-box">
            ...
            <form action="signupProcess" method="POST">
                <div class="form-group">
                    ...
                    <input type="email" class="form-input" id="email" name="email" required><br><br>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="password" class="form-input" id="confirmPassword" name="confirmPassword" required><br><br>
                </div>

                <div class="form-group">
                    <label class="form-label">Are you signing up as a Teacher or Student?</label><br>

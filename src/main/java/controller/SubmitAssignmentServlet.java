    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (filePart != null) {
            ...
            if (updated) {
                ...
                response.sendRedirect("AssignmentDetailsServlet?studentId=" + studentId + "&assignmentId=" + assignmentId + "&error=Submission+Failed");
            }
        } else {
            // Handle failure to upload the file
            response.sendRedirect("AssignmentDetailsServlet?studentId=" + studentId + "&assignmentId=" + assignmentId + "&error=No+file+uploaded");
        }
    }
}
